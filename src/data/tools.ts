...
/* Category-specific feature sets, so each comparison shows the criteria that
   actually matter for that category instead of a generic marketing checklist. */
export const featureCatalogByCategory: Record<string, FeatureDef[]> = {
  ...
  "social-media": [
    { key: "socialScheduling", label: "Post scheduling" },
    { key: "multiNetwork", label: "Multi-network publishing" },
    { key: "socialAnalytics", label: "Analytics & reporting" },
    { key: "socialInbox", label: "Unified inbox / engagement" },
  ...
  analytics: [
    ...
    { key: "funnels", label: "Funnel analysis" },
    { key: "retentionCohorts", label: "Retention & cohorts" },
    { key: "customDashboards", label: "Custom dashboards" },
    { key: "segmentation", label: "User segmentation" },
    { key: "sessionReplay", label: "Session replay" },
  ],
  "landing-pages": [
    { key: "pageBuilder", label: "Drag-and-drop builder" },
    { key: "abTesting", label: "A/B testing" },
    { key: "templates", label: "Template library" },
    { key: "popups", label: "Popups & sticky bars" },
    { key: "formsLeadCapture", label: "Forms & lead capture" },
    { key: "dynamicContent", label: "Dynamic / smart content" },
  ],
  "ai-content": [
    { key: "aiWriting", label: "AI writing" },
    { key: "brandVoice", label: "Brand voice controls" },
    { key: "templates", label: "Marketing templates" },
    { key: "seoOptimization", label: "SEO optimization" },
    { key: "teamWorkflows", label: "Team workflows" },
    { key: "factCheck", label: "Plagiarism / fact check" },
  ],
  "digital-adoption": [
    { key: "inAppGuidance", label: "In-app walkthroughs" },
    { key: "onboardingFlows", label: "Onboarding flows" },
    { key: "tooltips", label: "Tooltips & hotspots" },
    { key: "productAnalytics", label: "Usage analytics" },
    { key: "desktopCoverage", label: "Desktop / legacy app support" },
    { key: "noCodeEditor", label: "No-code editor" },
    { key: "surveysFeedback", label: "Surveys & feedback" },
  ],
};
